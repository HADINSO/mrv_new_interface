...
interface CardProps {
  estacion: {
    ...
    nombre: string;
    descripcion: string;
    lat: string;  // Si lat y lng son números, cámbialos a 'number' en lugar de 'string'
    lng: string;  // Lo mismo para lng
...
const Card: React.FC<CardProps> = ({ estacion }) => {
  return (
    <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-md mx-auto my-4 border border-gray-200 hover:shadow-xl transition-shadow">
